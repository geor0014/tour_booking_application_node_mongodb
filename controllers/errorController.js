...
module.exports = (err, req, res, next) => {
  ...
  if (process.env.NODE_ENV === 'development') {
    ...
    // we don't want to mutate the original error object so we create a new object and copy all the properties of err into it
    let error = {
      ...err, // copy all the properties of err into error object using spread operator
    };
